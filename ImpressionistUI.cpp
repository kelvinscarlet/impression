...
//-----------------------------------------------------------
// Updates the edge clipping to use from the value of the 
// edge clipping light button
// Called by the UI when the edge clipping light button is
// clicked
//-----------------------------------------------------------
void ImpressionistUI::cb_edgeClippingLightButton(Fl_Widget* o, void* v)
{
	((ImpressionistUI*)(o->user_data()))->m_nEdgeClipping = !(((Fl_Light_Button *)o)->value());
}

//-----------------------------------------------------------
// Updates the another gradient to use from the value of the 
// another gradient light button
// Called by the UI when the another gradient light button is
// clicked
//-----------------------------------------------------------
void ImpressionistUI::cb_anotherGradientLightButton(Fl_Widget* o, void* v)
{
	((ImpressionistUI*)(o->user_data()))->m_nAnotherGradient = !(((Fl_Light_Button *)o)->value());
}
...
//-------------------------------------------------
// Set the edge clipping
//-------------------------------------------------
void ImpressionistUI::setEdgeClipping(bool edgeClipping)
{
	m_nEdgeClipping = edgeClipping;
}
...
//-------------------------------------------------
// Set the another gradient
//-------------------------------------------------
void ImpressionistUI::setAnotherGradient(bool anotherGradient)
{
	m_nAnotherGradient = anotherGradient;
}
...
Fl_Menu_Item ImpressionistUI::menuitems[] = {
	{ "&File",		0, 0, 0, FL_SUBMENU },
		...
		//{ "&Color",	FL_ALT + 'k', (Fl_Callback *)ImpressionistUI::cb_color },
		//{ "&Painty", FL_ALT + 'p', (Fl_Callback *)ImpressionistUI::cb_painty, 0, FL_MENU_DIVIDER },
